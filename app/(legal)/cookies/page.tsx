...
const sections = [
  ...
  },
  {
    ...
    content: (
      <p>
        Si tienes preguntas sobre el uso de cookies o tecnologías similares, puedes contactarnos en <span className="text-white/70">ceo@inboundbasketballstudio.com</span>.
      </p>
    ),
  },
];
