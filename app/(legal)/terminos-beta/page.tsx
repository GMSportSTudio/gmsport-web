  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-2">
          En caso de problemas técnicos graves imputables exclusivamente al titular, se estudiará la situación de forma individual contactando con <span className="text-white/70">ceo@inboundbasketballstudio.com</span>.
        </p>
      </>
    ),
  },
