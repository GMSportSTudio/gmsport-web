...
const FAQS = [
  {
    q: "¿Cuándo sale la Beta?",
    a: "El acceso Beta está previsto para el 30 de abril de 2025. Todos los Founders recibirán un email con el enlace de descarga ese mismo día.",
  },
  {
