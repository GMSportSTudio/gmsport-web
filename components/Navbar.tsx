        ...
        <ul className="hidden md:flex items-center gap-8" role="list">
          {NAV_LINKS.map(({ label, href }) => (
            <li key={href}>
              <a
                href={href}
                className="relative text-sm text-[#EDEDED]/70 hover:text-[#06231F] transition-colors duration-200
                           after:absolute after:left-0 after:-bottom-0.5 after:h-px after:w-0 after:bg-[#22FFE0]
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.a
            ...
            className="hidden md:inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold
                       text-[#06231F] cursor-pointer select-none
                       bg-[#22FFE0] hover:bg-[#5FFFE8]
                       border border-[rgba(34,255,224,0.5)]
                       shadow-[0_1px_3px_rgba(0,0,0,0.4)]
                       hover:shadow-[0_0_0_1px_rgba(34,255,224,0.4),0_4px_16px_rgba(34,255,224,0.3)]
